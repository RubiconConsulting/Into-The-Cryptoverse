...
library Encounter {
  ...
  /**
   * @notice Get encountEvent.
   */
  function getEncountEvent(bytes32 player) internal view returns (bytes32 encountEvent) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = player;
   ...
   * @notice Get encountEvent.
   */
  function _getEncountEvent(bytes32 player) internal view returns (bytes32 encountEvent) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = player;
  ...
  /**
   * @notice Set encountEvent.
   */
  function setEncountEvent(bytes32 player, bytes32 encountEvent) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = player;

    StoreSwitch.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((encountEvent)), _fieldLayout);
  }

  /**
   * @notice Set encountEvent.
   */
  function _setEncountEvent(bytes32 player, bytes32 encountEvent) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = player;

    StoreCore.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((encountEvent)), _fieldLayout);
  }
   ...
   */
  function set(bytes32 player, bool exists, bytes32 encountEvent, uint256 catchAttempts) internal {
    bytes memory _staticData = encodeStatic(exists, encountEvent, catchAttempts);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(bytes32 player, bool exists, bytes32 encountEvent, uint256 catchAttempts) internal {
    bytes memory _staticData = encodeStatic(exists, encountEvent, catchAttempts);
  ...
  function set(bytes32 player, EncounterData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.exists, _table.encountEvent, _table.catchAttempts);
  ...
  function decodeStatic(
    bytes memory _blob
  ) internal pure returns (bool exists, bytes32 encountEvent, uint256 catchAttempts) {
    exists = (_toBool(uint8(Bytes.getBytes1(_blob, 0))));

    encountEvent = (Bytes.getBytes32(_blob, 1));
  ...
  function decode(
    ...
    (_table.exists, _table.encountEvent, _table.catchAttempts) = decodeStatic(_staticData);
  }
   ...
   */
  function encodeStatic(bool exists, bytes32 encountEvent, uint256 catchAttempts) internal pure returns (bytes memory) {
    return abi.encodePacked(exists, encountEvent, catchAttempts);
  }
